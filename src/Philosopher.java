...
//This is the philosopher class. It runs the program and makes the philosophers
...
{ 
   ...
   //This method tells each philosopher thread to eat, think, and wait
   //it also outputs the corresponding information at runtime of the thtreads
    public void run()  
    {
      ID = IDCounter++;
    ...
    //This is the main method. It creats the threads and creats the forks
